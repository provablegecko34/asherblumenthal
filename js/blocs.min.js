...
function blocs_welcomeModal1(){
	if (isElementVisible('md-body')) {
		var modal = new bootstrap.Modal('#modal_article_popup_2');modal.toggle();
	}
}
function blocs_welcomeModal2(){
	if (isElementVisible('xs-body')) {
...
>>>>>>> parent of 7ffae08 (Added modal to SM and XS sized screens)
