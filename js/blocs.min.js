...
function blocs_openMenusNotes(){
	document.getElementById("notes").click();
	toggleElementVisibility('notes-expanded');
	setTimeout(function(){blocs_replaceNotesText();}, 5);
	document.getElementById("notes").click();
	toggleElementVisibility('notes-expanded');
}
function blocs_replaceNotesText(){
	toggleElementVisibility('replaced-text');
}