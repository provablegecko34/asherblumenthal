...
function blocs_navigateToHillDay(){
	window.location.href = "asherblumenthal.com/hillday.html";
}
function blocs_newInteraction(){
	if (window.location.href == "asherblumenthal.com") {
		toggleElementVisibility('top-navbar,localhost:80085');
	}
}