...
function blocs_welcomeModalAndroid(){
	if (detectOS() == "android") {
		var modal = new bootstrap.Modal('#modal_article_popup_1');modal.toggle();
		var modal = new bootstrap.Modal('#modal_article_popup_2');modal.toggle();
	}
}
function blocs_welcomeModalIos(){
	if (detectOS() == "ios") {
		var modal = new bootstrap.Modal('#modal_article_popup_1');modal.toggle();
		var modal = new bootstrap.Modal('#modal_article_popup_2');modal.toggle();
	}
...
function detectOS() { const u = navigator.userAgent; return u.includes("iPhone") || u.includes("iPad") || u.includes("iPod") ? "ios" : u.includes("Android") ? "android" : u.includes("Mac") && !u.includes("Mobile") ? "macos" : u.includes("Win") ? "windows" : u.includes("Linux") && !u.includes("Android") ? "linux" : "other"; }